...
if motion_data is None:
    ...
    axs[0].set_title("Centre of Mass", fontsize=12)
    ...
    axs[1].set_title("Linear Velocity ", fontsize=12)
    ...
    axs[2].set_title("Angular Velocity ", fontsize=12)
    ...
    axs_force.set_xlabel("Time [s]", fontsize=12)
    axs_force.set_ylabel("Force [N]", fontsize=12)
    axs_force.set_title("Total Force", fontsize=12)
    ...
    axs_moment.set_xlabel("Time [s]", fontsize=12)
    axs_moment.set_ylabel("Moment [Nm]", fontsize=12)
    axs_moment.set_title("Total Moment ", fontsize=12)
...
axs[0].set_xlabel("Time [s]", fontsize=12)
axs[0].set_ylabel("Angle [deg]", fontsize=12)
...
axs[2].set_xlabel("Time [s]", fontsize=12)
axs[2].set_ylabel("Angle [deg]", fontsize=12)
